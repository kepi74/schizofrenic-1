...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/uMqv4u2XDc)
...
```sh
npx nx serve schizofrenic-1
```

To create a production bundle:

```sh
npx nx build schizofrenic-1
```

To see all available targets to run for a project, run:

```sh
npx nx show project schizofrenic-1
```
